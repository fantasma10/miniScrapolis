...
abstract class FlutterFlowTheme {
  ...
  late Color primariBagGroudBtn;
  late Color lineColor;
  late Color secundariBagGroudBtn;
  late Color textColorBtn;
  late Color tertiaryBagGroudBtn;
  late Color primariIcons;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF2E578A);
  late Color secondary = const Color(0xFFD2D2D2);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFFF5963);
  late Color primaryText = const Color(0xFF2E578A);
  late Color secondaryText = const Color(0xFF747474);
  ...
  late Color primariBagGroudBtn = const Color(0xFF0BAF4D);
  late Color lineColor = const Color(0xFFFFFFFF);
  late Color secundariBagGroudBtn = const Color(0xFF2E578A);
  late Color textColorBtn = const Color(0xFFFFFFFF);
  late Color tertiaryBagGroudBtn = const Color(0xFFCD0B39);
  late Color primariIcons = const Color(0xFF0BAF4D);
}
